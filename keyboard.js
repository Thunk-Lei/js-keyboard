...
;(function($) {
  $.fn.KeyBoard = function(options) {
    ...
    return this.each(function() {
      ...
      $(this)
        .find('.keyboard-numBtn')
        .append('<div class="row row_1"></div><div class="row row_2"></div><div class="row row_3"></div><div class="row row_4"></div>')
      $(this)
        .find('.keyboard-operation')
        .append('<div class="row row_1"></div><div class="row row_2">')
      ...
      $(this)
        .find('.keyboard-operation')
        .find('.row_1')
        .append('<div class="col-xs-12 keyboard-operation-delete" onclick="deleteBtn()"><i class="iconfont">&#xe620;</i></div>')
      if (defaults.type == 'password') {
        $(this)
          .find('.keyboard-operation')
          .find('.row_2')
          .append('<div class="col-xs-12 keyboard-operation-submit" onclick="submitBtn()">确定</div>')
      } else {
        $(this)
          .find('.keyboard-operation')
          .find('.row_2')
          .append('<div class="col-xs-12 keyboard-operation-submit" onclick="submitBtn()">支付</div>')
      }
